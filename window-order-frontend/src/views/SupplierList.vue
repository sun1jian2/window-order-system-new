    ...
    <div class="main-content">
      ...
      <el-card class="table-card" shadow="hover">
        <el-table :data="tableData" border stripe style="width: 100%" v-loading="loading" :header-cell-style="{background:'#f5f7fa', color:'#606266'}">
          <el-table-column prop="name" label="供应商名称" min-width="150" align="center" show-overflow-tooltip />
          ...
          <el-table-column prop="accountBalance" label="应付账款(元)" width="140" align="right">
